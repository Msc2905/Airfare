...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        miAddFlight = new JMenuItem("Add Flight");
        miBackToLogin = new JMenuItem("Back to Login");
        miExit = new JMenuItem("Exit");

        mnuAdmin.add(miAddFlight);
        mnuAdmin.add(miBackToLogin);
...
*/
		...
		miAddFlight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				Add_FlightActionPerformed(ae);
			}
		});
